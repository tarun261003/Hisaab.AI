...
from config import RAG_INITIALIZED
from initialize_sample_data import initialize_sample_receipts
...
if RAG_INITIALIZED:
    ...
    print("⚠️  RAG system initialization incomplete - some features may not work")
